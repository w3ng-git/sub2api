export default {
  ...
  admin: {
    ...
    usage: {
      ...
      errorTypeUpstream: 'Upstream Error',
      errorTypeConcurrency: 'Concurrency Limit',
      errorTypeForward: 'Forward Error',
      errorSearch: 'Error Search',
      errorSearchPlaceholder: 'Search error content...',
      ...
      headersCollapsed: 'Click to expand request headers',
      upstreamError: 'Upstream Error',
      upstreamEvents: 'Upstream Error Events',
      errorBody: 'Error Response Body',
      bodyCollapsed: 'Click to expand full response',
      cleanup: {
        button: 'Cleanup',
