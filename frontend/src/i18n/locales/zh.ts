export default {
  ...
  admin: {
    ...
    usage: {
      ...
      errorTypeUpstream: '上游错误',
      errorTypeConcurrency: '并发限制',
      errorTypeForward: '转发错误',
      errorSearch: '错误搜索',
      errorSearchPlaceholder: '搜索错误内容...',
      viewDetails: '查看详情',
      errorDetails: '错误详情',
      unknownError: '未知错误',
      upstream: '上游',
      requestInfo: '请求信息',
      requestHeaders: '请求头',
      headersCollapsed: '点击展开查看请求头',
      upstreamError: '上游错误',
      upstreamEvents: '上游错误事件',
      errorBody: '错误响应体',
      bodyCollapsed: '点击展开查看完整响应',
      cleanup: {
        button: '清理',
        title: '清理使用记录',
