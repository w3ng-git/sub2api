...
func ExpiresAt(v time.Time) predicate.APIKey {
	vc := time.Time(v)
	return predicate.APIKey(sql.FieldEQ(FieldExpiresAt, vc))
}
...
func ExpiresAtNEQ(v time.Time) predicate.APIKey {
	vc := time.Time(v)
	return predicate.APIKey(sql.FieldNEQ(FieldExpiresAt, vc))
}
...
func ExpiresAtIn(vs ...time.Time) predicate.APIKey {
	...
	return predicate.APIKey(sql.FieldIn(FieldExpiresAt, v...))
}
...
func ExpiresAtNotIn(vs ...time.Time) predicate.APIKey {
	...
	return predicate.APIKey(sql.FieldNotIn(FieldExpiresAt, v...))
}

// ExpiresAtGT applies the GT predicate on the "expires_at" field.
func ExpiresAtGT(v time.Time) predicate.APIKey {
	vc := time.Time(v)
	return predicate.APIKey(sql.FieldGT(FieldExpiresAt, vc))
}

// ExpiresAtGTE applies the GTE predicate on the "expires_at" field.
func ExpiresAtGTE(v time.Time) predicate.APIKey {
	vc := time.Time(v)
	return predicate.APIKey(sql.FieldGTE(FieldExpiresAt, vc))
}

// ExpiresAtLT applies the LT predicate on the "expires_at" field.
func ExpiresAtLT(v time.Time) predicate.APIKey {
	vc := time.Time(v)
	return predicate.APIKey(sql.FieldLT(FieldExpiresAt, vc))
}

// ExpiresAtLTE applies the LTE predicate on the "expires_at" field.
func ExpiresAtLTE(v time.Time) predicate.APIKey {
	vc := time.Time(v)
	return predicate.APIKey(sql.FieldLTE(FieldExpiresAt, vc))
}
