...
var (
	...
	GroupsColumns = []*schema.Column{
		...
		{Name: "cache_read_transfer_ratio", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(5,4)"}},
		{Name: "cache_read_transfer_probability", Type: field.TypeFloat64, Default: 1, SchemaType: map[string]string{"postgres": "decimal(5,4)"}},
	...
	UsageLogsColumns = []*schema.Column{
		...
		{Name: "error_status_code", Type: field.TypeInt, Nullable: true},
		{Name: "error_message", Type: field.TypeString, Nullable: true, Size: 2048},
		{Name: "error_body", Type: field.TypeString, Nullable: true, Size: 2147483647},
		...
		{Name: "upstream_error_message", Type: field.TypeString, Nullable: true, Size: 2147483647},
		{Name: "upstream_errors", Type: field.TypeString, Nullable: true, Size: 2147483647},
		{Name: "created_at", Type: field.TypeTime, SchemaType: map[string]string{"postgres": "timestamptz"}},
	...
	UsageLogsTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			{
				Name:    "usagelog_is_error",
				Unique:  false,
				Columns: []*schema.Column{UsageLogsColumns[25]},
			},
			{
				Name:    "usagelog_error_type",
				Unique:  false,
				Columns: []*schema.Column{UsageLogsColumns[26]},
			},
			{
				Name:    "usagelog_is_error_created_at",
				Unique:  false,
				Columns: []*schema.Column{UsageLogsColumns[25], UsageLogsColumns[34]},
			},
		},
	}
	...
	UsersColumns = []*schema.Column{
		...
		{Name: "cache_read_transfer_ratio", Type: field.TypeFloat64, Nullable: true, SchemaType: map[string]string{"postgres": "decimal(5,4)"}},
		{Name: "cache_read_transfer_probability", Type: field.TypeFloat64, Nullable: true, SchemaType: map[string]string{"postgres": "decimal(5,4)"}},
	}
